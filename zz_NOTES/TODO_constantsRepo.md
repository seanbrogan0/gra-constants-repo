...
- [ ] **Apple Team ID / App Store Connect registration**: register the app in App Store Connect and obtain the Apple Team ID needed to replace `TEAMID_PLACEHOLDER` in gra-web's `public/.well-known/apple-app-site-association`. Universal links will not verify until this is real.
      Affects: gra-mobile-app, gra-web
...
- [ ] **Sticker Printing** for QR codes to be printed on sticker labels and added to invitations. - Address label also possible candidate.
